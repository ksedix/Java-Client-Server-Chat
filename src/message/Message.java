...
public class Message implements Serializable {
    ...
    //this indicates if the message is an encrypted session key. In this case, the client handler
    //should not broadcast it, but forward it to the key receiver.
    ...
    public Message(String message) {
        //an unencrypted message will be an announcement
    ...
    public Message(String message, PublicKey publicKey) throws NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, NoSuchAlgorithmException, InvalidKeyException {
        //the only thing that is encrypted with public key is the session key so set this to be true
